    ...
    >
      ...
      <div class="absolute inset-0">
        <OptImage
          ...
          alt="Aerospace Industry Background"
      ...
      <!-- 内容区域 -->
      <div
        class="relative z-10 max-w-[1400px] mx-auto px-4 md:px-8 w-full text-center md:text-left"
      >
        <!-- 标题 - 移动端居中，桌面端左对齐 -->
        <h1
...
<script setup>
  ...
  const backgroundImagePath = computed(() => {
    ...
    return `/images/${theme}/industries/banner1.jpg`
  })
