      ...
      subItems: [
        {
          ...
          hasSubMenu: false,
          subItems: [
            { name: '领导团队', hasSubMenu: false },
            { name: '目标、使命与价值观', hasSubMenu: false },
            { name: '我们的历史', hasSubMenu: false },
            { name: '我们的愿景', hasSubMenu: false },
            { name: '公司治理', hasSubMenu: false },
          ],
        },
        {
          title: '我们如何工作',
          ...
          hasSubMenu: false,
          subItems: [
            { name: '联盟与收购', hasSubMenu: false },
            { name: '解决方案', hasSubMenu: false },
            { name: '客户能力网络', hasSubMenu: false },
            { name: '案例研究', hasSubMenu: false },
            { name: '从想法到影响', hasSubMenu: false },
          ],
        },
        {
          title: '我们的承诺',
          ...
          hasSubMenu: false,
          subItems: [
            { name: '多元化精英管理', hasSubMenu: false },
            { name: '经济机会', hasSubMenu: false },
            { name: '社会责任', hasSubMenu: false },
            { name: '环境可持续性', hasSubMenu: false },
            { name: '2024可持续和包容性增长报告', hasSubMenu: false },
          ],
        },
        {
          title: '继续探索',
          ...
          hasSubMenu: false,
          subItems: [
            { name: '媒体', hasSubMenu: false },
            { name: '麦肯锡博客', hasSubMenu: false },
          ],
        },
      ],
      featured: {
        ...
        items: [
          {
            name: '增长经济机会',
            description: '帮助组织蓬勃发展，经济繁荣，人民进步。',
            link: '/about/growing-economic-opportunity',
          },
          {
            name: '麦肯锡健康研究院',
            description: '我们的使命是让地球上的每个人都能延长寿命，让生命更有意义。',
            link: '/about/mckinsey-health-institute',
          },
          {
            name: '麦肯锡经济流动性研究院',
            description: '加速包容性增长。改善经济流动性。',
            link: '/about/economic-mobility-institute',
          },
        ],
      },
    },
